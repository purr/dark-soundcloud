...
(function () {
  ...
  // Function to start the observer when document is ready
...
/* Ensure sidebarHeader__actualTitle__webi__style is always white */
.sc-classic .sidebarHeader__actualTitle__webi__style {
  color: #ffffff !important;
}

/* Also ensure the sidebarHeader__actualTitle class is always white */
...
.sc-classic .featureHeader__closeButton, .sc-classic .g-button-remove {
...
.sc-classic .emptyNetworkPage.emptyReposts
.emptyNetworkPage__image,
.sc-classic .emptyNetworkPage.emptyAlbums
.emptyNetworkPage__image,
.sc-classic .emptyNetworkPage.emptyTracks
.emptyNetworkPage__image {
filter: invert(1);
}

.sc-classic .button-medium.sc-button-like:before {
filter: invert(1);
}
...
.sc-classic .blockCheckbox:not(.m-checked)
.blockCheckbox__icon {
...
.uiEvoButton--isLight, .uiEvoButton:hover.uiEvoButton--isLight, .uiEvoButton:link.uiEvoButton--isLight, .uiEvoButton:visited.uiEvoButton--isLight {
background-color: var(--jtc-sc-btn);
color: var(--jtc-sc-root-text);
}
...
/* Ensure buttons have proper filter */
...
/* Force sidebar title to be white with extremely high specificity */
html body .sc-classic .sidebarHeader__actualTitle,
html body .sc-classic .sidebarHeader__actualTitle__webi__style,
.sidebarHeader__actualTitle,
.sidebarHeader__actualTitle__webi__style,
span.sidebarHeader__actualTitle,
span.sidebarHeader__actualTitle__webi__style,
.sidebarHeader__title .sidebarHeader__actualTitle,
.sidebarHeader__title .sidebarHeader__actualTitle__webi__style,
.sc-link-light .sidebarHeader__actualTitle,
.sc-link-light .sidebarHeader__actualTitle__webi__style,
.sc-link-primary .sidebarHeader__actualTitle,
.sc-link-primary .sidebarHeader__actualTitle__webi__style,
a .sidebarHeader__actualTitle,
a .sidebarHeader__actualTitle__webi__style,
.g-flex-row-centered .sidebarHeader__actualTitle,
.g-flex-row-centered .sidebarHeader__actualTitle__webi__style,
.sidebarHeader .sidebarHeader__actualTitle,
.sidebarHeader .sidebarHeader__actualTitle__webi__style,
h4 .sidebarHeader__actualTitle,
h4 .sidebarHeader__actualTitle__webi__style {
  color: #ffffff !important;
  text-shadow: none !important;
  -webkit-text-fill-color: #ffffff !important;
}

/* Add !important to all color properties in the CSS */
.sidebarHeader a,
.sidebarHeader span,
.sidebarHeader h4,
...
.sidebarHeader.g-flex-row-centered-spread.sc-link-light.sc-link-primary.sidebar__moreLink.refresh-wtf.sc-border-light-bottom h4.sidebarHeader__title.sc-font.sc-link-primary.g-flex-row-centered.sidebarHeader__title__webi__style span.sidebarHeader__actualTitle.sidebarHeader__actualTitle__webi__style {
  color: #ffffff !important;
  text-shadow: none !important;
  -webkit-text-fill-color: #ffffff !important;
}

/* Make sidebarHeader__more__webi_style light grey */
.sc-classic .sidebarHeader__more__webi_style,
...
/* Make artistShortcutTile__username very light grey, almost white */
.artistShortcutTile__username,
.sc-classic .artistShortcutTile__username {
  color: #f0f0f0 !important;
  text-shadow: none !important;
  -webkit-text-fill-color: #f0f0f0 !important;
}

/* Make placeholder text in textfields a lighter grey */
.textfield__input.sc-input.sc-input-medium::placeholder,
input.textfield__input.sc-input.sc-input-medium::placeholder,
.sc-classic .textfield__input.sc-input.sc-input-medium::placeholder {
...
input.textfield__input.sc-input.sc-input-medium::-moz-placeholder,
.sc-classic .textfield__input.sc-input.sc-input-medium::-moz-placeholder {
  color: #bdbdbd !important;
  opacity: 1 !important;
}
...
input.textfield__input.sc-input.sc-input-medium::-webkit-input-placeholder,
.sc-classic .textfield__input.sc-input.sc-input-medium::-webkit-input-placeholder {
  color: #bdbdbd !important;
  opacity: 1 !important;
}
...
input.textfield__input.sc-input.sc-input-medium::-ms-input-placeholder,
.sc-classic .textfield__input.sc-input.sc-input-medium::-ms-input-placeholder {
  color: #bdbdbd !important;
  opacity: 1 !important;
}
`
  ...
  // Run the function initially when DOM is ready
  ...
  // Set up a MutationObserver to watch for DOM changes and reapply our styles
  try {
    const styleObserver = new MutationObserver((mutations) => {
      // Throttle the enforceStyles calls to avoid performance issues
      if (styleObserver.timeout) {
        clearTimeout(styleObserver.timeout);
      }
      styleObserver.timeout = setTimeout(enforceStyles, 100);
    });

    // Function to start the style observer
    ...
    // Start the style observer
    startStyleObserver();
  } catch (e) {
    console.warn("Error setting up MutationObserver: " + e.message);
    // Fallback to interval if MutationObserver fails
    setInterval(enforceStyles, 2000);
  }

  // Also set an interval as a backup to periodically check and enforce styles
  // This ensures styles are enforced even if the MutationObserver misses something
  const styleInterval = setInterval(enforceStyles, 5000);
